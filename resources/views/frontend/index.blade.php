...
<section class="banner-con position-relative">
    <div class="global_container_">
        <img class="naturali-import-web-hero-banner" src="{{ asset('frontend/images/naturali_import_web_hero_.png') }}" alt="Naturali Import Hero Banner" loading="lazy">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="categories-box">
                        <figure class="image mb-0">
                            <img src="{{ asset($category->image_name) }}" alt="image" class="img-fluid">
                        </figure>
                        <div class="content">
                            <h5 class="mb-0">{{$category->name}}</h5>
                                <a href="{{ route('category', ['id' => $category->id]) }}"><i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <?php }?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="categories_content text-center" data-aos="fade-up">
                    ...
                    <p>Browse through our different brands to find your favorite ice cream treats.</p>
                </div>
            </div>
        </div>
        <div class="categories_wrapper" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="categories-box">
                        <figure class="image mb-0">
                            <img src="{{ asset($brand->image_name) }}" alt="image" class="img-fluid">
                        </figure>
                        <div class="content">
...
<section class="update-con position-relative">
    <div class="container position-relative">
        <figure class="update-circle mb-0">
            <img src="{{asset('frontend/images/relive-circle.png') }}" alt="image" class="img-fluid">
        </figure>
        <figure class="update-triangle mb-0">
            <img src="{{asset('frontend/images/relive-triangle.png') }}" alt="image" class="img-fluid">
        </figure>
        <div class="row">
                ...
                <ul class="list-unstyled mb-0" data-aos="fade-up">
                    <li>
                        <a href="https://www.instagram.com/">
                            <figure class="image mb-0">
                                <img src="{{ asset('frontend/images/follow-image1.jpg') }}" alt="image" class="img-fluid">
                            </figure>
                    ...
                    <li>
                        <a href="https://www.instagram.com/">
                            <figure class="image mb-0">
                                <img src="{{ asset('frontend/images/follow-image2.jpg') }}" alt="image" class="img-fluid">
                            </figure>
                            <div class="icon"><i class="fa-brands fa-instagram" aria-hidden="true"></i></div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/">
                            <figure class="image mb-0">
                                <img src="{{ asset('frontend/images/follow-image3.jpg') }}" alt="image" class="img-fluid">
                            </figure>
                            <div class="icon"><i class="fa-brands fa-instagram" aria-hidden="true"></i></div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/">
                            <figure class="image mb-0">
                                <img src="{{ asset('frontend/images/follow-image4.jpg') }}" alt="image" class="img-fluid">
                            </figure>
                            <div class="icon"><i class="fa-brands fa-instagram" aria-hidden="true"></i></div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/">
                            <figure class="image mb-0">
                                <img src="{{ asset('frontend/images/follow-image5.jpg') }}" alt="image" class="img-fluid">
                            </figure>
                            <div class="icon"><i class="fa-brands fa-instagram" aria-hidden="true"></i></div>
                        </a>
                    </li>
...
<section class="footer-con position-relative">
    <figure class="footer-image mb-0">
        <img class="img-fluid" src="{{asset('frontend/images/footer-image.png') }}" alt="image">
    </figure>
    <div class="container">
                ...
                <div class="col-lg-2 col-md-12 col-sm-6 col-12 order-md-1 order-sm-1 order-1">
                    <a href="index.html">
                        <figure class="footer-logo mb-0">
                            <img class="img-fluid" src="{{asset('frontend/images/footer-logo.png') }}" alt="image">
                        </figure>
                    </a>
                </div>
